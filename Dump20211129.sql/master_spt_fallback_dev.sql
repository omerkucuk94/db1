...
--
-- Dumping data for table `spt_fallback_dev`
--

LOCK TABLES `spt_fallback_dev` WRITE;
/*!40000 ALTER TABLE `spt_fallback_dev` DISABLE KEYS */;
/*!40000 ALTER TABLE `spt_fallback_dev` ENABLE KEYS */;
UNLOCK TABLES;
