...
--
-- Dumping data for table `spt_fallback_db`
--

LOCK TABLES `spt_fallback_db` WRITE;
/*!40000 ALTER TABLE `spt_fallback_db` DISABLE KEYS */;
/*!40000 ALTER TABLE `spt_fallback_db` ENABLE KEYS */;
UNLOCK TABLES;
